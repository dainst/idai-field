...
describe('ConnectedDocsResolver', function () {
    ...
    beforeEach(function () {
        ...
        connectedDocsResolver = new connected_docs_resolver_1.ConnectedDocsResolver(projectConfiguration);
    });
    it('add one', function () {
        doc.resource.relations['BelongsTo'] = ['2'];
        var docsToUpdate = connectedDocsResolver.determineDocsToUpdate(doc, [relatedDoc]);
    ...
    it('add one and remove one', function () {
        ...
        relatedDoc.resource.relations['Contains'] = ['1'];
        var docsToUpdate = connectedDocsResolver.determineDocsToUpdate(doc, [relatedDoc, anotherRelatedDoc]);
    ...
    it('remove only', function () {
        ...
        var docsToUpdate = connectedDocsResolver.determineDocsToUpdate(doc, [relatedDoc], false);
        expect(docsToUpdate).toEqual([relatedDoc]);
...
//# sourceMappingURL=connected-docs-resolver.spec.js.map