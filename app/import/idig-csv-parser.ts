...
export class IdigCsvParser implements Parser {
    ...
    private documentFrom(object, i): ParserResult {
    ...
    private map(object, doc): ParserResult {

        var result: ParserResult = { document: doc, messages: [] };
    ...
    private parseGeometryString(geometryString): IdaiFieldGeometry {
        ...
        if (geometryString.startsWith("point")) {
            ...
            throw 'importer/info/nomultipolygonsupport';
        }
