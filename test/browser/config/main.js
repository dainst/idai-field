...
function packTestingUmd(pkgName) {
    config.packages['@angular/'+pkgName+'/testing'] =
        { main: '../bundles/' + pkgName + '-testing.umd.js', defaultExtension: 'js' };
}
ngPackageNames.forEach(packTestingUmd);
config.baseURL = '/base/';
