...
export const KOREAN_FIELDWORK_CATEGORY_LABELS: Readonly<Record<string, string>> = {
  ...
  [KOREAN_FIELDWORK_CATEGORIES.FEATURE_SEGMENT]: '피트·유구 세부 기록',
...
export const KOREAN_FIELDWORK_CATEGORY_DESCRIPTIONS: Readonly<Record<string, string>> = {
  ...
  [KOREAN_FIELDWORK_CATEGORIES.FEATURE_SEGMENT]: '피트, 절개 단면, 내부 퇴적처럼 유구 안의 세부 조사 단위입니다.',
...
export const KOREAN_FIELDWORK_HIDDEN_ADD_CATEGORIES: ReadonlyArray<string> = [
  'Image',
  'Process',
  'Project',
  'StoragePlace',
