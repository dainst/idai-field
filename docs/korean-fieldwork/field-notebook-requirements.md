...
| 보고서 역산 | 보고서 초록, 도면 목록, 사진대장, 유물·시료 목록은 나중에 따로 만드는 문서가 아니라 현장기록에서 생성되어야 한다. 편집방식, 원색도판, 인쇄소 인계, 최종교정, 판형·제본 계획도 어떤 원자료를 보고서 대표 증거로 삼았는지 남기는 판단 기록이다. | `FieldReportConcurrentReview`가 현장 중 원고·도면·사진 가편집본을 대조하고, `ReportPreparationReview`, `ReportStandardHistory`, `ReportEditorialCrossCheck`가 원고, 도면, 사진, 일지, 목록, 편집방식, 원색도판 선정, 인쇄소 인계자료, 기준 변경, 번호 변환표의 불일치를 원기록 ID와 연결한다. |
