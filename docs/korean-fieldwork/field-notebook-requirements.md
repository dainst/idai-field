...
11. 고분·분묘 기록이 묘형명 하나가 아니라 조사 목적, 봉분 트렌치, 성토 세분, 석곽 벽체, 내부 수습, 봉토·매장주체부·부장품 위치·인골 수습 기준으로 분리되는가.
