...
수혈건물지 자연과학 시료 보강분은 `Sample`에 `pitDwellingScienceSamplingPlan`을 배치했다. AMS 목탄·목재·패각, 고고지자기 피열토·토기편, 식물규산체·부유법 토양, 수종분석 목탄·목재, 레플리카·사용흔·전분·태토·지방산 분석 후보를 채취 시점, 위치도면, 강한 세척 회피, 오염위험 검토와 함께 기록한다.
