...
export class IdigCsvParser implements Parser {
    ...
    private static RELATION_FIELDS:string[] = [
        ...
        "RelationBelongsTo", "RelationBelongsTo_uuid", "RelationIncludes", "RelationIncludes_uuid",
        "RelationIsAbove", "RelationIsAbove_uuid", "RelationIsBelow", "RelationIsBelow_uuid", "RelationIsCoevalWith",
        "RelationIsCoevalWith_uuid"
    ];
    ...
    private relationName(relation) {
        var relN=relation.substring(0,relation.indexOf("_uuid"));
    ...
    private isMappableRelation(relation) {
        return (relation.indexOf("_uuid")!=-1)&&(this.relationName(relation)!="Relation");
    }
