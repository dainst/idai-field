...
| 25 | 제5회_매장문화재_조사연구원_교육_2008년8월.pdf | 464 | 직접 추출 | `method_25_21572f09.txt` | 추가 재대조 완료. 보고서 작성, 유적사진 촬영계획·조건, 자연과학 시료, 동물유체 동정·수습보존·분류·계량, 기능퇴적단위, 수로퇴적 동시성, 출토맥락 행위해석 항목 보강. 일본 가마 조사 강의 대목에서 테스트 트렌치 최종 주축 보정, 바닥면 평면선 우선 기록, 폐기장 범위·깊이 트렌치 확인, 사면 퇴적층 역전 가능성, 아궁이·연도·배연부 입체 단면 기록을 기와가마 체크값으로 반영 |
