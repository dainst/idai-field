...
2026-06-20 고환경분석 탄화곡물 장의 75-78쪽은 원문 이미지, PDF 텍스트층, OCR 보강본을 다시 확인했다. 현생 탄화 밀·보리, 무안 양장리·장흥 상방촌 사례, 길이·폭·두께 계측도, 폭/두께 산점도 군집은 식물유체 동정 기록의 근거로 유지하지만, 산점도와 비교사진의 별도 원출처 표기가 슬라이드 안에서 분명히 확인되지 않았으므로 `source-index-archaeobotany-001`에 `futurePdfRecheck`를 남겼다.
