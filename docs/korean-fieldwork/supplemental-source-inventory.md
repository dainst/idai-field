...
| 5 | 매장문화재_조사실무.pdf | 136 | 부분 추출 | `method_05_862bfa34.txt` | 추가 재대조 완료. 개인 야장의 공적 기록화, 제토 작업량, 문화층 상부 퇴적, 미지형·조망, 판단 변경 이력, 퇴적토 논리검토, 단계별 실측, 기록물 영구관리·열람관리 항목 보강. 2026-06-19 재대조에서 작은 소혈·주혈·노지·구가 배치도에서 점으로 축소되거나 누락되는 위험, 생활면과 최초 굴착면의 도면 차수 분리, 3D·실내 보완 도면의 현장 조사자 검수 필요를 추가 후보로 표시 |
