...
2026-06-19 감사에서 `고고학사전` PDF 12개와 추출 텍스트 12개, `조사방법론` PDF 31개와 추출 텍스트 31개의 대응을 다시 확인했다. 독해 작업의 다음 단계는 새 목록화가 아니라 OCR 취약 구간의 원문 이미지 교정과 실제 iDAI.field 템플릿 적용 검증이다.
