...
1. `KoreanFieldwork-*` 공통 값 목록: 기록 생성 시점, 검증상태, 현장기록 품질, 현장시점 누락점검, 최초 노출 기록, 일일 작업기록, 일지 증거 역할, 일지 검토, 개인 야장 공적기록화, 디지털 원자료 보존, 조사 행정 흐름, 허가조건 이행, 보존조치 이행, 조사자료 인계, 용어관계, 용어 검색·매핑, 용어 검증상태, 사전 분야, 용어 적용범위, 출처 우선순위, 지표조사 현장관찰, 지표조사 편향방지, 지표조사 후속조치, GIS·항공사진 예측근거, 예측 현장검증, 유적 패키지, 형식 논증, 편년 논증, 공반 관계, 시료 목적, 시료 채취·보관, 매체 증거 역할, 매체 품질검수, 보고서 교차검토, 보고서 평가 환류
