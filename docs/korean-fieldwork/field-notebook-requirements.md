...
29. 허가서 비치, 보안, 주민·관할기관 통보, 유적보호 주의사항, 기상 대비, 야간방범, 임시유물·기록물 보관이 행정 메모가 아니라 `Operation`의 `siteProtectionSecurity`로 남는가.
30. 구획·둑·배수·장비 제토·기준단면·안전휀스·철수 전 기록물 점검이 일지 문장 속에 묻히지 않고 `Operation`의 `excavationControlSafety`로 검수되는가.
