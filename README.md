...
The project is set up to have the compilation of the sources (test as well as regular sources) separately from angular. This is due to the fact that we do node based tests as we operate in an electron context. It is done on the 
