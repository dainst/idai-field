...
/**
 *
 * Collada loader taken from the three.js examples and modified in order to create geometries with
 * Float64BufferAttribute for vertex position values.
 *
...
ColladaLoader.prototype = {
    ...
    parse: function ( text, path ) {
        ...
        function buildGeometryType( primitives, sources, vertices ) {
            ...
            if ( position.array.length > 0 ) geometry.addAttribute( 'position', new THREE.Float64BufferAttribute( position.array, position.stride ) );
