...
| 고분 재독해 보강 | 장제와 묘제의 불일치, 목관묘 묘광·충전토·실토·요갱, 목곽묘 철기 수착 목질·회색점토·탄화 목곽·주혈, 복수 기준점·수준점, 10~20cm 수평제토, 토층둑 위치, 주구 재굴착·공유·성토부 되파기, 시상 외연·중첩·접속, 적석목곽 외곽·중곽·내곽·하부/개부 적석, 옹관고분 조사구획, 축조공정별 제사, 주칠·유기물 공헌 후보, 인골 개체식별 근거, 인골 분석 보고 항목 | `mortuaryPracticeRelation`, `woodenCoffinElement`, `woodenChamberTrace`, `moundExcavationControl`, `ditchRecutSequence`, `corpsePlatformObservation`, `stoneMoundTimberChamber`, `jarCoffinExcavationUnit`, `ritualChecklist`, `humanRemainsIndividualIdentification`, `humanRemainsAnalysisReport` | 제5권 재독해에서 핵심은 고분 형식명을 더 잘 붙이는 것이 아니라, 장제 행위·조사구획·미세 구조·수습 뒤 분석까지 이어지는 증거 사슬을 더 잘게 남기는 것이다. 목관·목곽·적석목곽·옹관·인골은 모두 현장 노출 중 사라지는 정보가 많으므로, 판단 보류와 대안 용어를 허용해야 한다. |
