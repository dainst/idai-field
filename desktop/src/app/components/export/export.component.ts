...
import { Category, Datastore, FieldDocument, Query, Resource } from 'idai-field-core';
...
export class ExportComponent implements OnInit {
    ...
    private async fetchOperationsAndPlaces(): Promise<Array<FieldDocument>> {
        ...
        const forest = this.projectConfiguration.getCategoryForest();
        const categories = ProjectCategories.getOverviewCategoryNames(forest).filter(name => name !== 'Operation');
