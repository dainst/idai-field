...
export class Map3DControls {
    ...
    private focusGeometry(document: FieldDocument) {
    ...
    private focusPointGeometry(document: FieldDocument) {

        const geometry: FieldGeometry = document.resource.geometry as FieldGeometry;
    ...
    private focusMeshGeometry(document: FieldDocument) {
