...
| 4 | 매장문화재_전문교육_보존과학_연구의_최신_성과와_과제2013년_9월.pdf | 106 | 부분 추출 | `method_04_b526e517.txt` | 추가 재대조 완료. 수침목재·칠기 응급보관, 목재유물 상태 기록, 금속·토도류 분석 의뢰, 인골 DNA 현장관리, 지류·직물 발견환경 유지, 유기물·토양 분석시료에 더해 보존처리 원칙, 표면약제 사용의 C14·후속처리 영향, 지류·직물 환경 적응과 취급 오염 방지 항목 보강 |
...
| 13 | 매장문화재조사_기초이론.pdf | 102 | 부분 추출 | `method_13_ce1850e9.txt` | 추가 재대조 완료. 표본조사 적합성, 시굴 보정계수, 지형별 트렌치 설계, 충적지 깊은 트렌치 안전, 정밀발굴 범위 산정, 행위 역순 발굴, `findSampleResearchScope` 유물·시료 범위 확장 항목 보강 |
...
| 17 | 발굴조사_실무.pdf | 205 | 직접 재추출 | `direct-recheck/발굴조사_실무_f0c001e8.txt` | 추가 반영 완료. 보고서 역산, 약식보고 자료, 성곽 기록, 자기요장 조사 항목에 더해 원삼국·삼국시대 주거지 조사계획, 토층둑·촬영·단계도면·유물 3차원 수습 보강. 추가 대조에서 바닥 제거 뒤 하부 주혈 확인, 주혈 단면 보완, 해체 후 최종도면, 평·단·입면 정합 검수를 생활유적 조사절차와 매체 품질검수 값으로 보강 |
...
| 26 | 조사요원_기초소양_교육.pdf | 342 | 직접 추출+OCR 보강+원문 이미지 대조 | `method_26_428b3ca9.txt` / `method26_drawing_artifacts_ocr.txt` / `method26_artifact_storage_rendered/page_309-313,321,324,330-338.png` | 추가 반영 완료. 조사보고서 작성법 장에서 자료 생성 시점, 보조원 자료대조, 보고서 기획회의, 도면·사진·원고 교차검토, 번호 변환표, 디지털사진 관리 항목 보강. 도면작성법 OCR로 고지도·지형도·지적원도·항공사진 원천자료, 좌표계 변환, 주변유적분포도/QGIS 조판 항목 보강. 유물 정리·보관 OCR로 수습-응급처치-보존처리-컨디션체크-국가귀속-이관, 재질별 수장환경과 수장고 동선 항목 보강. 이번 원문 이미지 대조에서 건/점/실수량/부속구 수량 산정 예시, 전시공간 오염물·조도 기준, 수장고 맞춤형 활용 원칙을 교정. 2026-06-20 추가 대조에서는 개별 포장의 온습도 피크 완충·결로 방지, 국가귀속·학술자료·미등록폐기유물의 이관 순서별 격납, 금속·목재·도토기류 미세환경, 입구 포장테이블과 door-to-door 상하차, 대형유물 크레인·추가 인력, 재질별 매뉴얼 숙지와 보고서 제출 전 컨디션 체크를 `storageEnvironmentControl` 보강 근거로 반영 |
...
| 28 | 지표조사_업무의_이해_교재.pdf | 84 | 부분 추출+재대조 완료 | `method_28_7b5882df.txt` | 추가 재대조 완료. 사전조사, 현장관찰, 지도요건, 탐문, 입지패턴, 후속조치 판단에 더해 문헌현장대조, 관찰편향방지, 행정제출패키지, 보존조치이행, 종합의견근거, 기존·신규 구분, 표본조사판단 항목 보강. 2026-06-20 원문 화면 20-26, 28, 36-37, 49, 53쪽 대조로 지표조사 결과 처리·부재판단 색인 후보 상태 확정 |
| 29 | 토기_제작의_이해와_실습.pdf | 168 | 직접 재추출 | `direct-recheck/토기_제작의_이해와_실습_e7badfd8.txt` | 추가 재대조 완료. 태토·수비·성형·정면·시문·건조·소성·보수 공정, 중첩소성·요도구·접지흔·용착흔, 토기요장 운영 규모와 시설 배치, 제작실습 변수와 분류판단근거 보강. 이번 구현에서 제작실험 변수, 분류 판단근거, 요장 운영 규모를 실제 값목록으로 옮김 |
| 30 | 현장조사_방법과_해석.pdf | 147 | 직접 추출+OCR 보강 | `method_30_96b66a06.txt` / `method30_pitdwelling_rotated_ocr.txt` | 추가 반영 완료. 구석기 그리드·지층조사와 기록 품질 보강. 수혈주거지 장은 회전 이미지 OCR로 평면확인-토층둑-1~3차 노출-외부시설조사 연속촬영, 토층둑 설정·분층기록, 유구·유물 사진각도, 마무리조사와 자연과학 시료, 중복주거지 조사순서 항목 보강. 134-135쪽 자연과학분석 표는 원문 이미지로 대조해 식물규산체 토양·토기편, 부유법 층별·바닥상층 격자토양, 전분 갈판·갈봉, 태토 기반토·토기, 지방산 토양·토기·석기·석재 항목을 교정하고 `Sample` 값목록 라벨과 조사종료 후 채취 체크로 옮김. 2026-06-19에는 평면확인, 토층둑 배치, 1~3차 노출, 동일 촬영지점·드론 경로, 외부시설 조사, 해체 후 최종평면, 토층둑·탐색 트렌치 설정 근거를 `pitDwellingInvestigationSequence`와 `pitDwellingSectionStrategy`로 추가 구현. 2026-06-20에는 인쇄 115·118·119쪽 슬라이드를 직접 확인해 매몰양상, 토층둑 설정, 직상방 사진 위주 촬영 회피, 측면사진·원근경·토층 전체/분할/세부 사진·역광 회피를 `mediaQualityCheck`와 수혈주거지 원문근거 색인에 반영 |
| 31 | 형식학적_연구의_이해2015년_9월.pdf | 59 | 직접 추출+원문 렌더링 대조 | `조사방법론_2015__9_d8f913a5.txt` / `method31_typology_rendered/*.png` | 추가 재대조 완료. 속성·형식·기종·양식 구분, 표지유물과 편년 적용의 검증상태, 공반·순서배열, 형식학 검증흐름과 잔존·혼입 위험 보강. 2026-06-20에는 추출문 Page 14, 23, 43, 45, 47, 50과 원문 이미지를 대조해 공반 반복성, 기능·용도와 지역차, 시간적 속성, 독립 방법 검증, 형식차=시간차 단정 금지, 과도한 세분 회피를 `typologyArgument`와 `chronologyArgument`에 추가 반영 |
...
| 2007, 한국성곽 용어사전.pdf | 397 | 부분 추출+OCR 재대조 | `고고학사전_2007_2f3c1981.txt` | 성곽 개설·시설 정의 대조용. 추출 품질이 낮아 최종 권위값은 2011년 성곽·봉수편과 조사방법론 제7권으로 대조하되, 원문/OCR 재대조로 성문 역할·형식과 구성부재, 오성지·누조·누혈·장군목·장군석 같은 화공대응·폐쇄 시설, 암문 기능, 여장 부재, 수문·수구·은구 구분, 해자·황·성황, 왜성 해자 기능, 왜성 곡륜 배치·호구 유형·건물/방어시설, 봉수 운영어, 각자성석 관계 보강. 2026-06-19 봉수 재대조에서 봉수대/봉화대 이칭, 연대·연조·봉조·거구 물리시설, 간봉·거화법·거수·감관 운영어 분리 근거로 재확인 |
...
| 국립문화유산연구원, 2011, 한국고고학전문사전 성곽·봉수편 | 1702 | 부분 추출 | `고고학사전_2011_9fed557e.txt` | 추가 재대조 완료. 성곽 시설 관계, 성문 방어시설, 수리·배수시설, 봉수 물리시설·노선·운영주체, 산성·봉수 복합관계 보강. 2026-06-19 봉수 항목 재대조에서 유적별 연대·연소실·건물지·외곽석축·방호벽과 대응봉수·노선 변동·감관·별장·봉군·봉군보 기록이 함께 나타나므로, `Feature`의 `beaconPhysicalFacility`, `beaconNetworkOperation`, `fortressBeaconRelation`으로 물리유구 속성과 문헌 기반 운영망 관계를 분리 구현 |
...
| 국립문화유산연구원, 2013, 한국고고학전문사전 구석기시대편 | 454 | 직접 추출 | `고고학사전_2013_3b6b052d.txt` | 추가 재대조 완료. 격지·몸돌·제작기법·문화층·토양쐐기에 더해 석재 표준명·산지근거, 사용흔, 접합·되맞추기, 석기군 공간관계, 르발루아·아슐리안·무스테리안 등 국외 용어 관계 보강. `dict2013_paleolithic_rendered` 원문 화면 13, 35, 69, 92, 100, 168, 184, 196쪽 대조로 `source-index-paleolithic-dictionary-001` 후보 상태 확정 |
...
| 국립문화유산연구원, 2022, 한국고고학전문사전 청동기시대편 증보판 1 | 1006 | 부분 추출 | `고고학사전_2022_1_da599e20.txt` | 추가 재대조 완료. 국내편 표제어·찾아가기 관계를 대조하고 송국리식 집자리, 가락동식/둔산식, 고인돌/지석묘, 환호, 민무늬/무문토기 이칭·관찰값 분리 원칙 보강. 2026-06-19 소형 시설 재대조에서 주혈/주공->기둥 구멍, 노지->화덕 자리, 굴립주 건물->기둥 건물, 수혈주거지->집자리 관계를 TermAlias 샘플에 추가 |
| 국립문화유산연구원, 2022, 한국고고학전문사전 청동기시대편 증보판 2 | 770 | 부분 추출 | `고고학사전_2022_2_09df21aa.txt` | 추가 재대조 완료. 국내편 고인돌 묘역시설·무덤방, 환호의 기능·퇴적·수축흔, 검단리식·송국리식 등 주거유형 관계와 토기 명칭 관계 보강. 구획구·구획면·파종 구덩이·발자국·도랑 동시성 같은 작은 흔적은 권위어 매핑이 아니라 현장 관찰값으로 남겨야 함을 보강 |
