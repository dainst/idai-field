...
const getStructureAction = (
  ...
  return {
    ...
    type: 'createDocument',
    label: `${childLabel} 추가`,
    detail: `${getKoreanFieldworkCategoryLabel(document.resource.category)}에 ${childLabel} 기록을 붙입니다.`,
...
const getOpenEvidenceAction = (
  ...
  return {
    ...
    detail: `${filledChip.documents.length}건의 ${filledChip.label} 근거가 있습니다.`,
