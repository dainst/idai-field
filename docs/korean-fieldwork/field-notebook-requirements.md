...
| 원자료 영구보존과 열람 | 야장, 원도면, 원사진, 보고서 미수록 자료, 실물 유물은 보고서 발간이나 국가귀속 뒤에도 재검토 자료다. 백업 여부와 열람 가능성, 제한 사유가 분리되어야 한다. | `digitalSourcePreservation`이 원야장 원본, 미수록 원도면·원사진, 실물 유물 열람, 열람신청, 제한 사유, 후속연구자·신진연구자 열람 이력, 두 곳 이상 백업과 보존연한 없음을 함께 추적한다. |
