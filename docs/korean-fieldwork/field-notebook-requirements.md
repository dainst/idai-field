...
| 매체의 기록 단위화 | 사진, 도면, 3D, GPS, GIS는 첨부파일이 아니라 판단 근거다. 사진은 좋은 구도보다 조사자 안전이 우선이므로 사다리·고소촬영 위험과 대체수단도 기록해야 하며, 유물사진은 실측도면과 보고서 도판을 검증하는 별도 기록이다. | 매체마다 목적, 대상, 방향, 기준점, 좌표계, 품질, 후처리, 재촬영·재실측 필요 여부를 가진다. `mediaQualityCheck`는 관련 구역 동시 기록, 내부 양방향 촬영, 색·수분 상태, 핵심 단면선, 복수 평면도, 평면·입단면 순서, 추정선·미조사 점선 구분, 장·단축 단면 연결, 산화·환원 색표기뿐 아니라 단계도면 축척·방향·평단면 불일치, 좌우반전·상하반전·뒤집힌 스캔, 저해상도·초점 흔들림·크롭 손상을 함께 점검한다. `Photo`의 `photoCaptureSafetyReview`는 붐대 카메라, 드론, 고소촬영 금지, 사다리 위험, 대체 촬영수단, 안전관리자 확인을 따로 남긴다. `artifactPhotoCaptureStandard`, `artifactPhotoLightingControl`, `artifactPhotoViewPlan`은 실측도면 동일각도, 그레이카드·화이트밸런스, 조명·반사 제어, 정면·측면·내면·굽·접사·질감 사진 계획을 유물사진 카드에 남긴다. |
| 원자료 영구보존과 열람 | 야장, 원도면, 원사진, 필름·슬라이드·밀착인화, 보고서 미수록 자료, 실물 유물은 보고서 발간이나 국가귀속 뒤에도 재검토 자료다. 백업 여부와 열람 가능성, 제한 사유가 분리되어야 한다. | `digitalSourcePreservation`이 원야장 원본, 미수록 원도면·원사진, 아날로그 필름, 슬라이드 필름, 밀착인화, 웹·서버 백업, 구매체 상태점검, 실물 유물 열람, 열람신청, 제한 사유, 후속연구자·신진연구자 열람 이력, 두 곳 이상 백업과 보존연한 없음을 함께 추적한다. `mediaQualityCheck`는 사진야장 대조와 인화 사진 주기 기록을 사진 품질 검수에 포함한다. |
