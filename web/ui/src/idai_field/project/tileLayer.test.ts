...
test('get tile layer extent', () => {
    ...
    let extent = getTileLayerExtent(DOC1 as any);
    ...
    extent = getTileLayerExtent(DOC2 as any);
...
test('get tile layer resolutions', () => {
    ...
    let extent = getTileLayerExtent(DOC1 as any);
    let resolutions = getResolutions(extent, 256, DOC1 as any);
    ...
    extent = getTileLayerExtent(DOC2 as any);
    resolutions = getResolutions(extent, 256, DOC2 as any);
