...
export const KOREAN_FIELDWORK_CATEGORY_LABELS: Readonly<Record<string, string>> = {
  ...
  [KOREAN_FIELDWORK_CATEGORIES.FEATURE_GROUP]: '유구 묶음',
  [KOREAN_FIELDWORK_CATEGORIES.FEATURE_SEGMENT]: '피트·세부 단위',
...
export const KOREAN_FIELDWORK_CATEGORY_DESCRIPTIONS: Readonly<Record<string, string>> = {
  ...
  [KOREAN_FIELDWORK_CATEGORIES.FEATURE_GROUP]: '목책열, 수혈 여러 기, 건물지 여러 동처럼 함께 다루는 묶음입니다.',
