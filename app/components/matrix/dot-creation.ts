...
export module DotCreation {
    ...
    export function createIsContemporaryWithEdgesDefinitions(documents: IdaiFieldFeatureDocument[]): string {
    ...
    export function createIsAfterEdgesDefinitions(documents: IdaiFieldFeatureDocument[]): string {
    ...
    export function createRootDocumentMinRankDefinition(documents: IdaiFieldFeatureDocument[]): string {
