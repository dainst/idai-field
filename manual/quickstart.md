...
gelöscht und alle Änderungen zurückgesetzt werden. Um mit dem Client produktiv zu
arbeiten, sollten Sie zunächst die folgenden Schritte durchführen:
...
die für sämtliche Projekte gelten. Hier sollten Sie zunächst Ihren Benutzernamen
festlegen. Dieser Name wird bei allen von Ihnen vorgenommenen Änderungen in der
Datenbank hinterlegt und sollte unbedingt gesetzt werden, bevor Sie Daten mit anderen
Clients synchronisieren.

2. Darüber hinaus können Sie im Menü **Einstellungen** den Pfad des Bilderordners
ändern. Das ist erforderlich, wenn Sie auf ein Bilderverzeichnis zugreifen möchten,
...
geladen wurde, können Sie über den Editierungs-Button in der Projektverwaltung darüber
hinaus allgemeine Metadaten des Projekts eingeben.
...
Bereichen **Ausgrabung**, **Bauaufnahmen** und **Survey** können Sie anschließend Ressourcen
