...
1. `KoreanFieldwork-*` 공통 값 목록: 기록 생성 시점, 검증상태, 현장기록 품질, 최초 노출 기록, 개인 야장 공적기록화, 디지털 원자료 보존, 조사 행정 흐름, 허가조건 이행, 보존조치 이행, 조사자료 인계, 용어관계, 용어 검증상태, 지표조사 현장관찰, 지표조사 편향방지, 지표조사 후속조치, 유적 패키지, 시료 목적, 시료 채취·보관, 보고서 교차검토
