...
readonly KoreanFieldworkNarrativeSnippet[] = [
  ...
  },
  {
    ...
    text: '현장 관찰과 해석을 분리하고, 최종 판단은 사진·도면·층위 관계 확인 후 보류함.',
    mode: 'append',
  },
  {
  ...
  },
  {
    ...
    icon: 'hub',
    target: 'description',
    text: '유구의 배치, 중복, 방향성을 기준으로 유구군 내부 관계를 구분하여 기록함.',
    mode: 'append',
  ...
  },
  {
    ...
    target: 'shortDescription',
    text: '유구 후보로 노출되어 경계와 충전토를 확인 중임.',
    mode: 'replace',
  ...
  },
  {
    ...
    icon: 'account-tree',
    target: 'interpretation',
    text: '인접 층위와의 선후관계는 단면 사진과 도면 확인 후 판단함.',
    mode: 'append',
    categoryNames: [C.LAYER],
  },
  {
