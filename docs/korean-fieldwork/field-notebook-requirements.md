...
31. 발굴맥락이 유구명 하나로 닫히지 않고 유적·유구·유물·유물복합체·환경 연결, 수평분포·수직층위, 조사방법 선택근거와 함께 남는가.
32. 표토·현대교란·도굴갱·상부퇴적토·유구 매몰토 제거와 축조면·사용면·폐기면 확인이 행위의 역순 원칙으로 검토되는가.
