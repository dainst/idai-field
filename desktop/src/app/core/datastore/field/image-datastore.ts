import { Datastore, IdaiFieldFindResult, ImageDocument, IndexFacade, PouchdbDatastore, Query, DocumentCache, CategoryConverter } from 'idai-field-core';
...
export class ImageDatastore
    extends Datastore<ImageDocument> {
