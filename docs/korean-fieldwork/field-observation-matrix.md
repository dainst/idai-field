...
| 형식·편년 논증 | 대표 속성, 변이, 흔적기관, 관련 유물군, 층위관계, 편년 대상 단위, 제작·사용·폐기 시점, 일괄유물, 폐기 동시성, 제작 동시성 불명, 전승품 가능성, 재사용 가능성, 지속시간 위험, 절대연대, 대안 편년, 채택 근거 | `typologyArgument`, `classificationBasis`, `typologyEvidence`, `chronologyUnitDecision`, `chronologyLifePhase`, `assemblageRelation`, `depositionContemporaneity`, `manufactureContemporaneityUnknown`, `chronologyDurationRisk`, `alternativeChronology`, `acceptedArgument` | 형식과 편년은 선택값이 아니라 논증이다. 수반유물은 매납·폐기 시점의 단서일 수 있지만 제작 시점을 자동으로 보장하지 않으므로, 일괄 관계와 대안 편년을 함께 남겨야 한다. |
