import { basicIndexConfiguration, Comparator, ConstraintIndex, IndexFacade, ProjectConfiguration, Tree } from 'idai-field-core';
...
export module IndexerConfiguration {
    ...
    export function configureIndexers(projectConfiguration: ProjectConfiguration, comparator: Comparator, showWarnings = true) {
        ...
        const createdConstraintIndex = ConstraintIndex.make({
            ...
            'isStoredIn:contain': { path: 'resource.relations.isStoredIn', pathArray: ['resource', 'relations', 'isStoredIn'], type: 'contain' },
            'isStoredIn:exist': { path: 'resource.relations.isStoredIn', pathArray: ['resource', 'relations', 'isStoredIn'], type: 'exist' },
            'isStoragePlaceOf:exist': { path: 'resource.relations.isStoragePlaceOf', pathArray: ['resource', 'relations', 'isStoragePlaceOf'], type: 'exist' },
