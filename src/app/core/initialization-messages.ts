const INITIALIZATION_MESSAGES = {
    'de': {
        ...
        'configuration/error/missingValuelist': 'Für das Feld "[0]" der Kategorie "[1]" wurde keine Werteliste definiert.',
        'configuration/error/missingPositionValuelist': 'Die Werteliste für das Unterfeld "Position" des Felds "[0]" der Kategorie "[1]” wurde nicht gefunden.',
    ...
    'en': {
        ...
        'configuration/error/missingValuelist': 'No value list is defined for the field "[0]" of category "[1]”.',
        'configuration/error/missingPositionValuelist': 'The value list for the subfield "position" of field "[0]" of category "[1]" was not found.',
