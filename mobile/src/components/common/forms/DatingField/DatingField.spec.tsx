...
describe('DatingField',() => {
    ...
    it('should call setFunction with correct values for type RANGE',() => {
        ...
        //fill Period Form
        fireEvent.changeText(getByTestId('begin_DatingElementText'),begin.toString());
        fireEvent(getByTestId('begin_DatingElementPicker'),'onValueChange',beginUnit);
    ...
    it('should call setFunction with correct values for type AFTER',() => {
        ...
        //fill After Form
        fireEvent.changeText(getByTestId('begin_DatingElementText'),end.toString());
        fireEvent(getByTestId('begin_DatingElementPicker'),'onValueChange',endUnit);
        fireEvent.changeText(getByTestId(SOURCE_TEST_ID),source);
        fireEvent.press(getByTestId(`${IS_IMPRECISE_ID}Btn`));
