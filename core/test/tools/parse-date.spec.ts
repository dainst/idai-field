...
describe('parseDate', () => {
    ...
    it('parse dates', () => {
        ...
        expect(parseDate('4.10.2021')?.toLocaleDateString()).toEqual('4.10.2021');
        expect(parseDate('10.09.2021')?.toLocaleDateString()).toEqual('10.9.2021');
        expect(parseDate('10.9.2021')?.toLocaleDateString()).toEqual('10.9.2021');
        expect(parseDate('29.02.2020')?.toLocaleDateString()).toEqual('29.2.2020');
        expect(parseDate('10.2021')?.toLocaleDateString()).toEqual('1.10.2021');
        expect(parseDate('09.2021')?.toLocaleDateString()).toEqual('1.9.2021');
        expect(parseDate('9.2021')?.toLocaleDateString()).toEqual('1.9.2021');
