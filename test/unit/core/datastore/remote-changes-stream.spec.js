...
describe('RemoteChangesStream', function () {
    var rcs;
    var doc;
    var datastore;
    var indexFacade;
    ...
    var documentCache;
    beforeEach(function () {
        doc = static_1.Static.doc('sd1', 'ident1', 'type1', 'id1');
        ...
        var fun;
        datastore.remoteChangesNotifications.and.returnValue({ subscribe: function (func) { return fun = func; } });
        datastore.remoteDeletedNotifications.and.returnValue({ subscribe: function (func) { return undefined; } });
        rcs = new remote_changes_stream_1.RemoteChangesStream(datastore, indexFacade, documentCache, typeConverter);
        fun(doc);
    });
    it('should put to index facade and reassign to cache', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    it('send through type converter', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
//# sourceMappingURL=remote-changes-stream.spec.js.map