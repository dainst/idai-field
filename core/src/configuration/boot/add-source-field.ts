...
function setFieldSourceOnForms(forms: Map<BaseFormDefinition|undefined>, value: Field.SourceTypes) {
...
function setFieldSourceOnFields(fields: Map<BaseFieldDefinition>, value: Field.SourceTypes) {
