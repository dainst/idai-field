...
describe('completeInverseRelations', () => {
    ...
    const sameOperationRelations = [
        'isContemporaryWith', 'isEquivalentTo', 'isBefore', 'isAfter', 'isBelow', 'isAbove', 'liesWithin'
    ];
    ...
    test('set inverse relation between import resources', () => {
        ...
        const documents = completeInverseRelations(
            makeDocumentsLookup([doc1, doc2]), targetsLookup, inverseRelations, sameOperationRelations
        );
        expect(documents.length).toBe(0);
    });


    test('set inverse relation between import resources - complement inverse', () => {
    ...
    test('set inverse relation between import resources - complement inverse, add to array', () => {
    ...
    test('set inverse relation with database resource', () => {
        ...
        doc1.resource.relations[IS_BELOW] = ['2'];
        const documents = completeInverseRelations(
            makeDocumentsLookup([doc1 as any]), targetsLookup, inverseRelations, sameOperationRelations
        );
    ...
    test('set inverse relation with database resource - add to already existing relation array', () => {
    ...
    test('add two to the same', () => {
        ...
        const documents = completeInverseRelations(
            makeDocumentsLookup([doc1 as any, doc2 as any]), targetsLookup, inverseRelations, sameOperationRelations
        );
        expect(documents.length).toBe(1);
    ...
    test('add two to the same - which already has a relation', () => {
    ...
    test('remove one - where they are also related by other relation', () => {
    ...
    test('remove one - where they are not related by other relations', () => {
    ...
    test('do not complete liesWithin and isRecordedIn relation', () => {
        ...
        const documents = completeInverseRelations(
            makeDocumentsLookup([doc2]), targetsLookup, inverseRelations, sameOperationRelations
        );
    ...
    test('bad range - between import and db resource - structural relation (LIES_WITHIN)', () => {
        ...
        try {
            completeInverseRelations(
                makeDocumentsLookup([doc1]), targetsLookup, inverseRelations,
    ...
    test('bad range - between import and db resource - structural relation (RECORDED_IN)', () => {
    ...
    test('bad range - between import and db resource - non-structural relation', () => {
    ...
    test('bad range - between import resources - structural relation (LIES_WITHIN)', () => {
        ...
        try {
            completeInverseRelations(
                makeDocumentsLookup([doc1, doc2]), undefined, inverseRelations,
                sameOperationRelations, assertIsAllowedRelationDomainCategory
            );
            throw new Error('Test failure');
        } catch (errWithParams) {
    ...
    test('bad range - between import resources - structural relation (RECORDED_IN)', () => {
    ...
    test('bad range - between import resources - non-structural relation', () => {
        ...
        try {
            completeInverseRelations(
                makeDocumentsLookup([doc1, doc2]), get, inverseRelations,
                sameOperationRelations, assertIsAllowedRelationDomainCategory
            );
            throw new Error('Test failure');
        } catch (errWithParams) {
    ...
    test('illegal relation between import resources', () => {
    ...
    test('illegal relation between import and db resource', () => {
    ...
    test('legal relation between import and db resource', () => {
    ...
    test('opposing directions targeting same resource' +
    ...
    test('mutually exclusive directions targeting same resource' +
        ' - import resource to import resource' +
        ' - set both directions in one resource', () => {
    ...
    test('set inverse relation within between import resources - also ignore if conflict is coming from a relation which is its own inverser', () => {
    ...
    function expectBadInterrelation(docs, err2, targetsLookup) {
        ...
        try {
            completeInverseRelations(
                makeDocumentsLookup(docs), targetsLookup, inverseRelations, sameOperationRelations
            );
            throw new Error('Test failure');
        } catch (errWithParams) {
