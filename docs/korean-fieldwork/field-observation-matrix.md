...
| 유기물·무기물 분석 | 목재·종자·인골·동물뼈·화분·기생충알·식물규산체, 고DNA 오염관리, 토양 LOI·pH·total lipid·sterol, 도·토기·도자기·안료·금속·유리·석재, XRD·XRF·SEM-EDS·ICP-MS·금속현미경·납동위원소, 비파괴/파괴 여부, 산지·제작기술·보존상태 해석 | `conservationScienceRequest`, `metalAnalysisRequest`, `ceramicConservationState`, `humanDnaFieldControl`, `organicSoilAnalysisSample`, `destructiveAnalysisDecision` | 유기물과 무기물 분석은 재질군별 질문이 다르다. 유기물은 오염과 보존 조건, 무기물은 분석 방법과 파괴 범위, 원료·산지·제작기술·보존상태 해석을 함께 관리해야 한다. 이번 구현에서는 `Find`에 보존과학 의뢰·금속분석·토도류 보존상태를, `Sample`에 DNA 현장관리·유기물/토양 분석·파괴분석 결정을 배치했다. |
...
| 분석 신뢰도 | 비파괴, 준파괴, 파괴, 표면오염, 부식층 영향, 덧칠 영향, 경원소 한계, 표준시료, 교차검증, 시료크기 부족, 보존원칙 충돌, 분석 승인 필요, 절단·연마·부식 여부, 잔여 시료 보관, 분석결과영향 | `destructiveAnalysisDecision`, `conservationScienceRequest`, `metalAnalysisRequest` | 자연과학 분석은 장비명이 아니라 신뢰도 조건을 함께 기록해야 한다. 비파괴 분석은 보존에 유리하지만 표면 상태의 영향을 받기 쉽고, 파괴 분석은 신뢰도를 높일 수 있으나 승인과 보존 판단이 필요하다. 이번 구현에서는 파괴 정도, 표면오염·부식층·덧칠 영향, 표준시료·교차검증, 분석 승인, 시료 제작 이력, 잔여 시료 보관, 분석결과 영향 검토를 `Sample` 화면에서 관리한다. |
