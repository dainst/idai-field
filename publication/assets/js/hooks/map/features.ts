...
export const loadFeatureCollection = async function (
  projectKey: string,
  draftDate: string,
) {
...
export const findFeaturesAtPixel = function (pixel: Pixel, map: Map) {
  return map.getFeaturesAtPixel(pixel, {
    layerFilter: (layer: VectorLayer<VectorSource<Feature<Geometry>>>) => {
