...
var result_sets_1 = require("../../../../../app/core/datastore/index/result-sets");
/**
...
describe('ResultSets', function () {
    it('basic stuff', function () {
        var r = result_sets_1.ResultSets.make();
    ...
    it('no intersection with more results', function () {
        var r = result_sets_1.ResultSets.make();
        r = r.combine([{ id: '1' }, { id: '2' }]);
        r = r.combine([{ id: '2' }, { id: '3' }]);
    ...
    it('subtract and add multiple', function () {
        var r = result_sets_1.ResultSets.make();
        r = r.combine([{ id: '1' }, { id: '2' }, { id: '3' }, { id: '4' }]);
...
//# sourceMappingURL=result-sets.spec.js.map